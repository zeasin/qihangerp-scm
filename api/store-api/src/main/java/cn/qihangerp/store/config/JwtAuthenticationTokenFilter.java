//package cn.qihangerp.store.config;
//
...
//            if( !appId.equals(appKey)) {
//                fallback(" appId不存在！", response);
//                return;
//            }
//        }
//
...
//        if (request.getRequestURI().contains("/dou/msg/order_msg")) {
...
//                || request.getRequestURI().contains("/open/")
...
//                || request.getRequestURI().contains("/dou/msg")
//                || request.getRequestURI().contains("/wei/msg")
//        ) {
//            // 登录页面，放行 || request.getRequestURI().equals("/order/get_detail")
//            log.info("======放行{}========",url);
//            chain.doFilter(request, response);
...
//            }
//            AjaxResult res = AjaxResult.error(401, message);
