    ...
    <div class="relative h-full flex mx-auto">
      ...
      >
        ...
        <div class="flex items-center relative text-white">
          ...
          <span class="text-20px font-bold">aaaa{{ underlineToHump(appStore.getTitle) }}</span>
        </div>
        <!-- 左边的背景图 + 欢迎语 -->
        <div class="flex justify-center items-center h-[calc(100%-60px)]">
          ...
          >
            ...
            <div key="2" class="text-3xl text-white" style="text-align: center;">AAA{{ t('login.welcome') }}</div>
      ...
      <div class="flex-1 p-30px <sm:p-10px dark:bg-v-dark relative">
        ...
        <div class="flex justify-between items-center text-white @2xl:justify-end @xl:justify-end">
          <div class="flex items-center @2xl:hidden @xl:hidden">
            <img alt="" class="w-48px h-48px mr-10px" src="@/assets/imgs/logo.png" />
            <span class="text-20px font-bold">aaa{{ underlineToHump(appStore.getTitle) }}</span>
          </div>
