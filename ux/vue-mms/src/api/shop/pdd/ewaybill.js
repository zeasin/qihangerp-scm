...
export function cancelWaybillCode(data) {
  return request({
    url: '/api/store-api/pdd/ewaybill/cancel_waybill_code',
    method: 'post',
    data: data
  })
}
...
export function getWaybillTemplateList(params) {
  return request({
    url: '/api/store-api/pdd/ewaybill/get_waybill_template_list',
    method: 'get',
    params: params
  })
}
export function updateAccount(data){
  return request({
    url: '/api/store-api/pdd/ewaybill/updateAccount',
    method: 'post',
    data: data
  })
}
export function shareSupplier(data) {
  return request({
    url: '/api/store-api/pdd/ewaybill/shareSupplier',
    method: 'post',
    data: data
  })
}
