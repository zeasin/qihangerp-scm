<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="退款单号" prop="afterSaleOrderId">
        <el-input
      ...
      <el-form-item label="类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择类型" clearable @change="handleQuery">
          ...
          <el-option label="退款退货" value="RETURN"></el-option>
    ...
    <el-table v-loading="loading" :data="taoRefundList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="退款单号" align="left" prop="afterSaleOrderId" width="160px">
        <template slot-scope="scope">
         {{scope.row.afterSaleOrderId}}
        <i class="el-icon-copy-document tag-copy" :data-clipboard-text="scope.row.afterSaleOrderId" @click="copyActiveCode($event,scope.row.afterSaleOrderId)" ></i>
      ...
      <el-table-column label="类型" align="center" prop="type" >
        <template slot-scope="scope">
          ...
          <el-tag size="small" v-if="scope.row.type === 'EXCHANGE'"> 换货</el-tag>
        </template>
      </el-table-column>
...
<!--       <el-table-column label="商品skuId" align="center" prop="skuId" />-->
      ...
      <el-table-column label="退款原因" align="left" prop="reasonText" />
...
import {listShopRefund, pullRefund,pushOms} from "@/api/wei/refund";
